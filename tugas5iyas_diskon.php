<html>
	...
	<body>
		...
		<form action="tugas5iyas.php" method="POST">
		<table class="center">
			<tr><td>
				<label>IDR
	...
	<table class="center">
			...
			<div class="div">
				<?php
					...
					if ($disk > 0) {
						echo "Total belanja anda setelah diskon sebesar <i><b>IDR ".$hasil.",00</b></i> <br> diskonnya sebesar <b><i>IDR ".$diskon.",00</b></i><br>Terimakasih telah belanja di Aamiin Mart :)";
						}
